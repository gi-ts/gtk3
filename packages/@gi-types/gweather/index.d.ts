...
export module LocationEntry {
    export interface ConstructorProperties extends Gtk.SearchEntry.ConstructorProperties {
        [key: string]: any;
        location: Location;
...
export class LocationEntry
    ...
    constructor(properties?: Partial<LocationEntry.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<LocationEntry.ConstructorProperties>, ...args: any[]): void;
...
export class TimezoneMenu
    ...
    constructor(properties?: Partial<TimezoneMenu.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<TimezoneMenu.ConstructorProperties>, ...args: any[]): void;
...
export class LocationEntryPrivate {
    ...
    constructor(copy: LocationEntryPrivate);
}
